...
**Part 1 (`week-01/manual/`) was written without any AI assistance:** no (used gemini for output format)
<!-- If "no", say exactly what was assisted. An honest "no" costs far less than an undisclosed "yes". -->

**Everything I submitted, I can explain and defend in class:** no
...
I dont know for what this files:
.prettierignore
.prettierrc
